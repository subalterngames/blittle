...
impl Rgba32Surface {
    #[inline]
    pub fn pixel_to_l8(pixel: &Vec4) -> u8 {
        L32Surface::f32_to_u8(Self::pixel_to_l32(pixel))
    }
    #[inline]
    pub fn pixel_to_la8(pixel: &Vec4) -> [u8; 2] {
        [
            L32Surface::f32_to_u8(Self::pixel_to_l32(pixel)),
    ...
    #[inline]
    pub fn pixel_to_l32(pixel: &Vec4) -> f32 {
        (pixel * 256.).xyz().element_sum() / 3.
    }

    #[inline]
    pub fn pixel_to_la32(pixel: &Vec4) -> [f32; 2] {
    ...
    #[inline]
    pub fn pixel_to_rgba8(pixel: &Vec4) -> [u8; 4] {
        let pixel = pixel * 256.;
        let pixel = pixel.deref();
    ...
    #[inline]
    pub fn pixel_to_zrgb8(pixel: &Vec4) -> u32 {
        let p = pixel * 256.;
        let p = p.deref();
